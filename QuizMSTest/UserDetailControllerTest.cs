    ...
    public class UserDetailControllerTest
    {
        ...
        public void GetRoleDetailTest()
        {
            var items = new List<Userdetail>
            {
                ...
                new Userdetail { UserId = 2, IsActive = 1, CreatedBy = 2,EmployeeId=1,EmployeeName = "sample", CreatedOn = DateTime.Now}
            };
            ...
            Assert.IsTrue(leveltwo.CreatedBy == 2);
        ...
        public void GetActiveQuestionsTest()
        {
            var users = new List<Userdetail>  {
                ...
                new Userdetail { UserId = 14, IsActive = 0, CreatedBy = 2,EmployeeId=1,EmployeeName = "sample", CreatedOn = DateTime.Now }
            };
            ;
        ...
        {
            _dbContext.Userdetails.Add(new Userdetail { UserId = 10, IsActive = 1, CreatedBy = 1, EmployeeId = 3, EmployeeName = "sample1", CreatedOn = DateTime.Now });
            _dbContext.SaveChanges();

            var level = _quizRepository.GetUserDetailByEmployeeeId(3);
        ...
        public void UpdateRoleDetailLevelTest()
        {
            ...
            var UserInsert = _quizRepository.InsertUserDetail(new Userdetail() { UserId = 6, IsActive = 0, CreatedBy = 1, EmployeeId = 2, EmployeeName = "sample", CreatedOn = DateTime.Now });
