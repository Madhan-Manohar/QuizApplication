...
namespace QuizTest
{
    ...
    public class Userroletest
    {
        ...
        public void GetUserRoleTest()
        {
            ...
            {
                new Userrole { UserRoleId = 1, RoleId = 1, Userid = 1, CompanyId = 1, IsActive=1, CreatedBy="1", CreatedOn=DateTime.Now, ModifiedBy="1",ModifiedOn=DateTime.Now }
            };
            ...
            Assert.IsTrue(quizone.Userid == 1);
        ...
        {
            _dbContext.Userroles.Add(new Userrole { UserRoleId = 1, RoleId = 1, Userid = 1,  CompanyId = 1, IsActive = 1, CreatedBy = "1", CreatedOn = DateTime.Now, ModifiedBy = "1", ModifiedOn = DateTime.Now, });
            _dbContext.SaveChanges();
            //var getUserRole = _dbContext.Userroles.Where(x => x.RoleId == 1).First();
            //Assert.IsTrue(getUserRole.CreatedBy == 1);
            //Assert.IsTrue(getUserRole.CompanyId == 1);
            ...
            Assert.IsTrue(quiz.Result.Userid == 1);
            Assert.IsTrue(quiz.Result.CreatedBy == "1");
        }
        [TestMethod]
        public void InsertUserRoleTest()
        {
            var level = _UserRoleService.InsertUserroleAsync(new Userrole() { UserRoleId = 6, RoleId = 1, Userid = 1, CompanyId = 1, IsActive = 1, CreatedBy = "1", CreatedOn = DateTime.Now, ModifiedBy = "1", ModifiedOn = DateTime.Now });
            Assert.IsTrue(level.Result.UserRoleId == 6);
        }
        [TestMethod]
        public void InsertUserRolesTest()
        {
            var quizdetailinsert = _UserRoleService.InsertUserroleAsync(new Userrole() { UserRoleId = 8, RoleId = 1, Userid = 1, CompanyId = 1, IsActive = 1, CreatedBy = "1", CreatedOn = DateTime.Now, ModifiedOn = DateTime.Now });
        ...
        {
            var insert = _UserRoleService.InsertUserroleAsync(new Userrole() { UserRoleId= 9, RoleId = 1, Userid = 1, CompanyId = 1, IsActive = 1, CreatedBy = "1", CreatedOn = DateTime.Now, ModifiedOn = DateTime.Now });
            var update = _UserRoleService.UpdateUserroleAsync(new Userrole() { UserRoleId = 9, RoleId = 2, Userid = 2, CompanyId = 1, IsActive = 1, CreatedBy = "1", CreatedOn = DateTime.Now, ModifiedOn = DateTime.Now });



            Assert.IsTrue(update.Userid == 2);
        }
        [TestMethod]
